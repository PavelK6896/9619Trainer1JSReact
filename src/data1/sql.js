export const SQLKeyword = [ // SQLKeyword Ключевые слова
...
export const MySQLStringFun = [ // MySQLStringFun functions Строчные функции
...
export const MySQLNumericFun = [ //MySQL Числовые функции MySQLNumericFun function
...
export const MySQLDateFun = [//MySQL Функции даты MySQLDateFun // functions
...
export const MySQLAdvancedFeature = [ // MySQL Расширенные функции MySQLAdvancedFeature
...
export const SQLServerStringFun = [//SQL Server функции строк SQLServerStringFun functions
    ["ASCII", "Возвращает значение ASCII для конкретного символа"],
...
export const SQLServerMathFun = [ // SQL Server Функции математические и числовые SQLServerMathFun
    ["ABS", "Возвращает абсолютное значение числа"],
    ["ACOS", "Возвращает арккосинус числа"],
    ["ASIN", "Возвращает арксин числа"],
...
export const SQLServerDateFun = [//SQL Server функции дат the SQLServerDateFun
    ["CURRENT_TIMESTAMP", "Возвращает текущую дату и время"],
...
export const SQLServerExtendedFun = [//SQL Server Функции расширенния SQLServerExtendedFun
    ["CAST", "Преобразует значение (любого типа) в указанный тип данных"],
    ["COALESCE", "Возвращает первое ненулевое значение в списке"],
...
export const PostgreSQLKeyword = [//PostgreSQL SQLKeyword
    //PostgreSQL типы запросов
    ...
    ["Create User", "	Создать учетную запись базы данных"],
    ["Grant/Revoke Privileges", "	Предоставление и отмена привилегий в БД"],
    ["Change Password", "	Изменить пароль пользователя"],
    ["Find Users", "	Поиск пользователя"],
    ["Find Users Logged In", "	Найти пользователей, вошедших в PostgreSQL"],
    ...
    //PostgreSQL таблицы и представления
	...
	//PostgreSQL ключи, индексы и ограничения
